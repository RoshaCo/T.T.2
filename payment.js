/* =========================================================
   ...
   به‌روزرسانی: متن‌های هماهنگ با مفهوم بلیت ورود
========================================================= */
...
(function () {
  ...
  function showPaymentSuccess(order) {
    ...
    if (paymentResultContent) {
      paymentResultContent.innerHTML = `
        ...
        <p>
          اکنون می‌توانید محصول خریداری‌شده را
          دریافت کنید.
        </p>
      `;
    }
  ...
  async function handlePaymentReturn() {
    ...
    try {
      ...
      showPaymentFailure(
        "امکان بررسی وضعیت پرداخت وجود ندارد. لطفاً دوباره تلاش کنید."
      );
    }
  }
    ...
    if (!isValidMobile(mobile)) {
      ...
      if (postPurchaseResult) {
        ...
        postPurchaseResult.textContent =
          "برای شرکت در قرعه‌کشی شماره خودتان را که با صفر شروع می‌شود وارد کنید و دقت کنید شماره کامل ۱۱ رقمی باشد.";
      }
    ...
    try {
      ...
      if (
        ...
        if (postPurchaseResult) {
          ...
          postPurchaseResult.textContent =
            "شماره شما با موفقیت ثبت شد و شانس شما برای دوره جاری فعال شد.";
        }
