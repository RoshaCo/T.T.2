/* =========================================================
   ...
   قیمت ثابت هر محصول: ۳۵,۰۰۰ تومان
========================================================= */
...
(function () {
  ...
  const form =
    document.getElementById("chanceForm");

  const mobileInput =
    document.getElementById("chanceMobile");

  const submitButton =
    document.getElementById("chanceSubmit");

  const resultBox =
    document.getElementById("chanceResult");
  ...
  /* ---------------------------------------------------------
     قیمت ثابت محصولات
     ۳۵۰,۰۰۰ ریال = ۳۵,۰۰۰ تومان
     --------------------------------------------------------- */

  const PRODUCT_PRICE_RIAL = 350000;
  const PRODUCT_PRICE_TOMAN = 35000;
  ...
  async function lookupChance() {
    ...
    /*
      شماره موبایل در این بخش اجباری است.
    */
