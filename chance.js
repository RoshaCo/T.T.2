/* =========================================================
   ...
   به‌روزرسانی: تغییر متن‌ها برای اعتمادسازی
========================================================= */
...
(function () {
  ...
  function showMobileError() {
    showMessage(
      ...
      "برای بررسی شرایط خود، شماره‌ای را که با آن خرید کرده‌اید وارد کنید. شماره باید کامل و ۱۱ رقمی باشد.",
      `
  ...
  function renderNonBuyerResult() {
    showMessage(
      ...
      "برای ورود به قرعه‌کشی کافی است یکی از محصولات ۲۹٬۰۰۰ تومانی را به عنوان بلیت ورود تهیه کنید.",
      `
        <button
          type="button"
  ...
  mobileInput.addEventListener(
    ...
    function () {
      ...
      if (hint) {
        hint.textContent =
          "شماره موبایل خودتان را با صفر وارد کنید.";
      }
    }
  );
